...
public class SQLTokenizer {
			...
			case '\'':
				if (comment != NOT_COMMENT) {
					...
					if (i + 1 < sql.length && sql[i + 1] == quote) {
						...
						tokens.add(new SQLToken(quoteBuffer.toString(),
	...
	static Map<Integer, String> keywords = new HashMap<Integer, String>(337);
	...
	static final int COUNTER = 324; // alias for INT IDENTITY, is used from MS
									// ACCESS
	...
	// NUMERIC FUNCTIONS
	static final int ABS = 1000; // first numeric function --> see
	...
	static final int TRUNCATE = 1023; // last numeric function --> see
										// SSDatabaseMetaData.getNumericFunctions
	static {
		addKeyWord("ABS", ABS);
	...
	// String Functions
	static final int ASCII = 1100; // first string function --> see
	...
	static final int UCASE = 1122; // last string function --> see
									// SSDatabaseMetaData.getStringFunctions
	static {
	...
	static final int CURDATE = 1200; // first time date function --> see
	...
	static final int YEAR = 1219; // last time date function --> see
									// SSDatabaseMetaData.getTimeDateFunctions
	static {
