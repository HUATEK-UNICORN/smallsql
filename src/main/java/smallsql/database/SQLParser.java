...
final class SQLParser {
	 ...
	 * 
	 * @param token
	 *            the SQLToken with the column name
	 ...
	 *            one of SQLTokenizer.PRIMARY, SQLTokenizer.UNIQUE or
	 ...
	 * 
	 * @param isEscape
	 *            true then the data types start with "SQL_". This is used for
	 *            the Escape Syntax.
	 */
	 ...
	 * 
	 * @param cmd
	 *            is needed to add parameters "?" with addParameter()
	 ...
	 * @param cmd
	 *            is needed to add parameters "?" with addParameter()
	 * @param previousOperationLevel
	 *            the level of the left operation.
	 */
	 ...
	 * 
	 * @param token
	 *            the SQLToken of the function
	 * @param isEscape
	 *            If the function is a FN ESCAPE sequence
	 */
