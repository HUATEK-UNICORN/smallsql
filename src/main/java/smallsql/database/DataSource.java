...
/**
 * This class implements the interface to access the data of a RowSource. It is
 * a top level RowSource It is a abstract class because interfaces are ever
 * public.
 * 
 * Know Implementations are: - TableResult - GroupResult
 * 
 * * @author Volker Berlin
 * 
 */
