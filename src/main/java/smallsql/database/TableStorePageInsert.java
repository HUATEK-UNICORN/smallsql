 ...
 * Because a new StorePage has no filepos before it was commit it is difficult
 * to refind the StorePage after if was commit With this link the StorePage can
 * be refind if it was commit and save or not.
 * 
 * @author Volker Berlin
 */
