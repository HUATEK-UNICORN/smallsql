...
public class Identity extends Number implements Mutable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 879032488871180507L;
	...
	public Identity(FileChannel raFile, long filePos) throws IOException {
		...
		value = ((long) (page[0]) << 56) | ((long) (page[1] & 0xFF) << 48)
				| ((long) (page[2] & 0xFF) << 40)
				| ((long) (page[3] & 0xFF) << 32)
				| ((long) (page[4] & 0xFF) << 24) | ((page[5] & 0xFF) << 16)
				| ((page[6] & 0xFF) << 8) | ((page[7] & 0xFF));
		this.raFile = raFile;
